...
import { Palette, Moon, Sun, Sliders, RotateCcw, Check } from 'lucide-react';
...
export function ThemeSection() {
  ...
  const contrastValue = themeContrast ?? DEFAULT_CONTRAST;
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[11px] text-muted">
                ({getContrastLabel(contrastValue).label})
              </span>
            </div>
          ...
          <div className="pt-2 border-t border-border/40 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            ...
            <div className="inline-flex p-0.5 bg-bg/80 border border-border/70 rounded-lg">
              {[
                ...
                const isActive = contrastValue === preset.value;
                return (
                  <button
                    key={preset.label}
                    type="button"
            ...
            <div className="flex items-center gap-2 mt-2 px-1">
              ...
              {(() => {
                const liveVars = computeThemeVariables(theme, contrastValue);
                return (
