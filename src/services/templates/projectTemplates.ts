...
export const PROJECT_TEMPLATES: ProjectTemplate[] = [
  {
    ...
    badge: 'Popular',
    description: 'React 19 + TypeScript starter skeleton with modular components.',
    iconName: 'react',
...
`,
  ...
  },
  {
    ...
    name: 'Tailwind CSS',
    badge: 'Recommended',
    description: 'Tailwind CSS v4 utility styling with reactive components.',
    iconName: 'tailwind',
...
`,
  ...
  },
  {
    ...
    name: 'Empty Project',
    badge: 'Minimal',
    description: 'Clean slate with minimal files for custom architectures.',
    iconName: 'empty',
    defaultProjectName: 'Empty Workspace',
    tags: ['Minimal', 'Clean Slate', 'Blank'],
...
`,
  ...
  },
  {
    ...
    badge: 'Lightweight',
    description: 'Lightweight HTML5, CSS3, and JavaScript without framework overhead.',
    iconName: 'javascript',
